import { ByRoleOptions as ByRoleOptions_, Matcher, MatcherOptions as MatcherOptions_, SelectorMatcherOptions as SelectorMatcherOptions_, waitForOptions } from '@testing-library/dom';
...
declare type ByRoleOptions = Omit<ByRoleOptions_, 'normalizer'>;
interface IQueryMethods {
    ...
    findByRole(el: Element, m: Matcher, opts?: ByRoleOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByRole(el: Element, m: Matcher, opts?: ByRoleOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
