...
function SearchBar() {
    return (
        <>
            <form class="absolute w-full flex items-center justify-center py-2">   
                <div class="relative w-2/5">
                    <div class="searchbar-icon">
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-500"
                    ...
                    <input type="text" id="voice-search" class="searchbar-input"
